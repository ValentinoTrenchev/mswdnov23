...
if ($beanWeight >= 30 && $waterWeight >= 150) {
  echo "<p>Cofee machine working ...</p>";
} else {
  echo "<p>Please check coffee beans and water!</p>";
}
...
if ($beanWeight >= 30 || $grindWeight >= 20){
  ...
  echo "You do not have enough coffee";
}
...
switch ($bingo) {
  ...
  case 90: echo "<p>The olf woman, number 90</p>"; break;
